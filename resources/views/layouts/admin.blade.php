    ...
    <head>
        ...
        @section('scripts')
            ...
            <style>
                ...
                .content-wrapper .btn-default {
                    background-image: linear-gradient(135deg, rgba(59,130,246,0.25), rgba(16,185,129,0.20));
                ...
                /* Sidebar: glassmorph + white text */
                .main-sidebar {
                    background: linear-gradient(180deg, rgba(34, 197, 94, 0.12), rgba(59, 130, 246, 0.12));
                ...
                .main-sidebar .sidebar-menu > li > a:hover {
                    background: linear-gradient(90deg, rgba(59,130,246,0.16), rgba(16,185,129,0.12)) !important;
                }
                .main-sidebar .sidebar-menu > li.active > a,
                .main-sidebar .sidebar-menu > li > a:focus {
                    background: linear-gradient(90deg, rgba(59,130,246,0.22), rgba(16,185,129,0.18)) !important;
                }
                ...
                .main-header,
                .main-header .navbar {
                    background: linear-gradient(180deg, rgba(34,197,94,0.16), rgba(59,130,246,0.16));
                    -webkit-backdrop-filter: blur(12px);
                    backdrop-filter: blur(12px);
                ...
                .content-wrapper .alert-success { background: rgba(34,197,94,0.30); border-color: rgba(34,197,94,0.55); }
                ...
                .content-wrapper .pagination > .active > span {
                    background: linear-gradient(135deg, rgba(59,130,246,0.30), rgba(16,185,129,0.26));
                    border-color: rgba(255,255,255,0.35);
                }
