...
export const lightTheme: ThemeVariables = {
    ...
    '--bg-input': '#FFFFFF',
    '--bg-hover': '#F8FAFC',
    '--bg-active': 'rgba(124, 58, 237, 0.05)',
    '--bg-code': '#F1F5F9',
    '--bg-tooltip': '#0F172A',
    ...
    '--shadow-md': '0 14px 30px 0 rgba(168, 85, 247, 0.24)',
    ...
    '--shadow-focus': 'rgba(168, 85, 247, 0.25) 0px 0px 0px 3px',
    '--shadow-btn-primary': '0 14px 30px 0 rgba(168, 85, 247, 0.24)',
    '--shadow-btn-primary-hover': '0 18px 36px 0 rgba(168, 85, 247, 0.32)',

    // Navigation
    '--nav-bg': '#FFFFFF',
    '--nav-shadow': '0 -10px 30px 0 rgba(15, 23, 42, 0.08)',
    '--nav-text': '#64748B',
    '--nav-text-hover': '#7C3AED',
    '--nav-hover-bg': '#F8FAFC',
    ...
    '--sidebar-active-bg': 'rgba(124, 58, 237, 0.05)',
    ...
    // Gradient overlays
    '--gradient-hero': 'linear-gradient(135deg, rgba(236, 72, 153, 0.08) 0%, rgba(124, 58, 237, 0.08) 100%)',
    '--gradient-hero-border': 'rgba(124, 58, 237, 0.1)',
    '--gradient-hero-radial': 'radial-gradient(circle at 100% 50%, rgba(236, 72, 153, 0.2) 0%, transparent 70%)',
...
export const darkTheme: ThemeVariables = {
    ...
    '--shadow-md': '0 14px 30px 0 rgba(124, 58, 237, 0.15)',
    ...
    '--shadow-focus': 'rgba(168, 85, 247, 0.35) 0px 0px 0px 3px',
    '--shadow-btn-primary': '0 14px 30px 0 rgba(168, 85, 247, 0.18)',
    '--shadow-btn-primary-hover': '0 18px 36px 0 rgba(168, 85, 247, 0.25)',

    // Navigation
    '--nav-bg': '#0F172A',
    '--nav-shadow': '0 4px 12px 0 rgba(0, 0, 0, 0.4)',
    '--nav-text': '#94A3B8',
    '--nav-text-hover': '#A855F7',
    '--nav-hover-bg': '#1E293B',
    ...
    '--sidebar-text-active': '#A855F7',
    '--sidebar-hover-bg': '#1E293B',
    '--sidebar-active-bg': 'rgba(124, 58, 237, 0.12)',
    ...
    // Gradient overlays
    '--gradient-hero': 'linear-gradient(135deg, rgba(236, 72, 153, 0.12) 0%, rgba(124, 58, 237, 0.12) 100%)',
    '--gradient-hero-border': 'rgba(124, 58, 237, 0.2)',
    '--gradient-hero-radial': 'radial-gradient(circle at 100% 50%, rgba(236, 72, 153, 0.15) 0%, transparent 70%)',
