...
const VariableBox = ({ variable }: Props) => {
    ...
    return (
        <TitledGreyBox
            title={
                <p className='text-[10px] uppercase font-black tracking-widest text-neutral-900'>
                    {!variable.isEditable && (
        ...
        >
            ...
            <p className='mt-4 text-xs text-neutral-500 font-bold leading-relaxed'>{variable.description}</p>
        </TitledGreyBox>
    );
};
