...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ children, shape, size, variant, palette, appearance, className, ...rest }, ref) => {
        return (
            <button
                ref={ref}
                className={classNames(
                    ...
                    styles.primary,
                    {
                        ...
                        [styles.oval]: shape === Options.Shape.Oval,
                        [styles.small]: size === Options.Size.Small,
                        [styles.large]: size === Options.Size.Large,
                        [styles.glass]: appearance === 'glass',
                    },
                    palette ? styles[`palette-${palette}`] : undefined,
                    className
                )}
                {...rest}
            >
