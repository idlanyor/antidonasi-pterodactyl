...
module.exports = {
    ...
    theme: {
        extend: {
            fontFamily: {
                header: ['Raleway', '"IBM Plex Sans"', '"Roboto"', 'system-ui', 'sans-serif'],
                sans: ['Raleway', '"IBM Plex Sans"', '"Roboto"', 'system-ui', 'sans-serif'],
            },
            colors: {
                black: '#000000',
                'brand-navy': '#0F172A',
                ...
                'accent-purple-light': 'var(--accent)',
                'accent-lavender': 'var(--accent)',
